...
class UpdateProductRequest extends FormRequest
{
    ...
    {
        $productId = $this->route('product') ?? $this->route('own_product'); // Ajusta según tu nombre de ruta
        ...
        if ($partnerId) {
            ...
            if ($partner && $partner->requiresWarehouses()) {
                ...
                // Partner tipo Asociado: almacén OPCIONAL
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            // Validar permisos de producto propio
