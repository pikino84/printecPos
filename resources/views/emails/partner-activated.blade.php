...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
        ...
        <p>¡Excelentes noticias! Tu cuenta de partner en Printec ha sido revisada y <strong style="color: #11998e;">activada exitosamente</strong>.</p>
        ...
        <div style="background: #fff; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #11998e;">
            <h3 style="margin-top: 0; color: #11998e;">¿Qué puedes hacer ahora?</h3>
        ...
        <p>Si tienes alguna duda o necesitas ayuda, no dudes en escribirnos a <a href="mailto:ebutron@printec.mx" style="color: #11998e;">ebutron@printec.mx</a></p>
