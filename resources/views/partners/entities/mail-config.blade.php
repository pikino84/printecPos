...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col-md-12">
            ...
            <p class="text-muted mb-0">{{ $entity->razon_social }} — Partner: <strong>{{ $partner->name }}</strong></p>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form id="mail-config-form" action="{{ route('partners.entities.mail-config.update', [$partner, $entity]) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="alert alert-info">
                        <h6><i class="feather icon-info"></i> Importante</h6>
                        <p class="mb-0">Para poder enviar cotizaciones desde el correo del partner, debes configurar los datos SMTP de su proveedor de correo.
                    ...
                    <div class="form-check mb-4">
                        ...
                        <small class="text-muted">
                            ...
                            Las cotizaciones solo se enviaran desde este correo si esta opcion esta activa.
                        </small>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('partners.entities.index', $partner) }}" class="btn btn-outline-secondary">
                            <i class="feather icon-arrow-left"></i> Volver a razones sociales
                        </a>
                    </div>
                </form>
            </div>
...
function testMailConfig() {
    ...
    fetch('{{ route("partners.entities.mail-config.test", [$partner, $entity]) }}', {
        method: 'POST',
        body: formData
    })
