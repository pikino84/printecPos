        ...
        <div class="navbar-container container-fluid">
            ...
            <ul class="nav-right">
                ...
                <li class="header-notification">
                    <a href="{{ route('cart.index') }}" class="waves-effect waves-light position-relative">
                        <i class="feather icon-shopping-cart"></i>
                        <span class="badge bg-c-pink cart-badge" id="cart-count-badge" style="display: none; right: 3px;">0</span>
                    </a>
                </li>
                        ...
                        <ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            ...
                            <li>
                                <a href="{{ route('quotes.index') }}">
                                    <i class="feather icon-file-text"></i> Mis Cotizaciones
                                </a>
                            </li>
                            <li>
